...
const initialVal = [{ srcno: "1", desc: "", qty: "1", rate: "1.00", amnt: "1" }];

export const AuthContextProvider = (props) => {

  const [invoiceHeadData, setInvoiceHeadData] = useState({
    invNum: "1",
    dueDate: "",
  })
  ...
  const onAdditemHandler = (e) => {
    ...
    allItem.push({ srcno: "", desc: "", qty: "1", rate: "1.00", amnt: "1" })
